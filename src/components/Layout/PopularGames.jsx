                ...
                <div className="relative flex items-center justify-center sm:justify-normal gap-4">
                    {showBackBtn && (
                        <button 
                            type="button" 
                            onClick={handleBack}
                            className="back-btn aria-disabled:cursor-not-allowed aria-disabled:opacity-75 flex-shrink-0 disabled:cursor-not-allowed flex-shrink-0 text-ellipsis focus-visible:outline-0 font-bold rounded-lg text-base px-4 py-3 text-theme-secondary-500 bg-transparent ring-1 ring-inset ring-current disabled:ring-theme-secondary-500 disabled:bg-transparent disabled:opacity-30 focus-visible:ring-theme-secondary-500 focus-visible:ring-2 focus:outline-theme-secondary-500/20 focus:bg-theme-secondary-500/10 focus:outline focus:outline-4 hover:bg-theme-secondary-500/10 items-center justify-center max-w-fit gap-4 pl-3 pr-5 md:flex"
                        >
