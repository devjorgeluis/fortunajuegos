                ...
                <div className="flex items-center gap-4">
                    ...
                    <a onClick={() => navigate("/")} className="block lg:mr-8 cursor-pointer" title="Logo">
                        <svg width="140" height="50" viewBox="0 0 140 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <text x="10" y="33" fontFamily="'Bebas Neue', Arial Black, sans-serif" fontStyle={"italic"} fontSize="20" fontWeight="bold" fill="white" letterSpacing="2">FORTUNA</text>
                            <text x="78" y="33" fontFamily="'Bebas Neue', Arial Black, sans-serif" fontStyle={"italic"} fontSize="20" fontWeight="bold" fill="#F5C20A" letterSpacing="2">VIP2</text>
                        </svg>
                    </a>
                </div>
